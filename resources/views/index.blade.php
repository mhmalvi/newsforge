...
@section('content')
    <div class="container">
                ...
                <div class="row gutter--15">
                    <div class="col-md-6">
                        ...
                        <div class="post--item post--layout-1 post--title-larger">
                            <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/banner-01.jpg')}}" alt=""></a>
                        ...
                        <div class="row gutter--15">
                            <div class="col-xs-6 col-xss-12">
                                ...
                                <div class="post--item post--layout-1 post--title-large">
                                    <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/banner-02.jpg')}}" alt=""></a>
                            ...
                            <div class="col-xs-6 hidden-xss">
                                ...
                                <div class="post--item post--layout-1 post--title-large">
                                    <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/banner-03.jpg')}}" alt=""></a>
                            ...
                            <div class="col-sm-12 hidden-sm hidden-xs">
                                ...
                                <div class="post--item post--layout-1 post--title-larger">
                                    <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/banner-04.jpg')}}" alt=""></a>
                                        <a href="#" class="cat">Politics</a>
                ...
                <div class="sticky-content-inner">
                    <div class="row">
                                ...
                                <ul class="nav row gutter--15" data-ajax-content="inner">
                                    <li class="col-xs-12">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/world-news-01.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/world-news-02.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/world-news-03.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/world-news-04.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/world-news-05.jpg')}}" alt=""></a>
                            ...
                            <div class="post--items post--items-3" data-ajax-content="outer">
                                <ul class="nav" data-ajax-content="inner">
                                    <li>
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/technology-01.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/technology-02.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/technology-03.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/technology-04.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/technology-05.jpg')}}" alt=""></a>
                        ...
                        <div class="col-md-12 ptop--30 pbottom--30">
                            ...
                            <div class="ad--space">
                                <a href="#">
                                    <img src="{{asset('assets/img/ads-img/ad-728x90-01.jpg')}}" alt="" class="center-block">
                                </a>
                            </div>
                            <!-- Advertisement End -->
                        </div>
                            ...
                            <div class="post--items post--items-2" data-ajax-content="outer">
                                <ul class="nav row" data-ajax-content="inner">
                                    <li class="col-md-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/finance-01.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-md-6">
                                        <ul class="nav row">
                                            ...
                                            <li class="col-xs-6">
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/finance-02.jpg')}}" alt=""></a>
                                            ...
                                            <li class="col-xs-6">
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/finance-03.jpg')}}" alt=""></a>
                                            ...
                                            <li class="col-xs-6">
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/finance-04.jpg')}}" alt=""></a>
                                            ...
                                            <li class="col-xs-6">
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/finance-05.jpg')}}" alt=""></a>
                            ...
                            <div class="post--items post--items-2" data-ajax-content="outer">
                                <ul class="nav row gutter--15" data-ajax-content="inner">
                                    <li class="col-xs-12">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/politics-01.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/politics-02.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/politics-03.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/politics-04.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/politics-05.jpg')}}" alt=""></a>
                            ...
                            <div class="post--items post--items-3" data-ajax-content="outer">
                                <ul class="nav" data-ajax-content="inner">
                                    <li>
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/sports-01.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/sports-02.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/sports-03.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/sports-04.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/sports-05.jpg')}}" alt=""></a>
            ...
            <div class="main--sidebar col-md-4 col-sm-5 ptop--30 pbottom--30" data-sticky-content="true">
                <div class="sticky-content-inner">
                    ...
                    <div class="widget">
                        ...
                        <div class="ad--widget">
                            <a href="#">
                                <img src="{{asset('assets/img/ads-img/ad-300x250-1.jpg')}}" alt="">
                            </a>
                        </div>
                        <!-- Ad Widget End -->
                    </div>
                            ...
                            <div class="post--items post--items-3" data-ajax-content="outer">
                                <ul class="nav" data-ajax-content="inner">
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/widgets-img/news-widget-01.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/widgets-img/news-widget-02.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/widgets-img/news-widget-03.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/widgets-img/news-widget-04.jpg')}}" alt=""></a>
                    ...
                    <div class="widget">
                        ...
                        <div class="ad--widget">
                            <a href="#">
                                <img src="{{asset('assets/img/ads-img/ad-300x250-2.jpg')}}" alt="">
                            </a>
                        </div>
                        <!-- Ad Widget End -->
                    </div>
                ...
                <ul class="nav row" data-ajax-content="inner">
                    <li class="col-md-8">
                        ...
                        <div class="post--item post--layout-1 post--type-video post--title-large">
                            <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/audio-video-01.jpg')}}" alt=""></a>
                        ...
                        <ul class="nav">
                            <li>
                                ...
                                <div class="post--item post--type-audio post--layout-3">
                                    <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/audio-video-02.jpg')}}" alt=""></a>
                            ...
                            <li>
                                ...
                                <div class="post--item post--type-video post--layout-3">
                                    <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/audio-video-03.jpg')}}" alt=""></a>
                            ...
                            <li>
                                ...
                                <div class="post--item post--type-video post--layout-3">
                                    <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/audio-video-04.jpg')}}" alt=""></a>
                            ...
                            <li>
                                ...
                                <div class="post--item post--type-audio post--layout-3">
                                    <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/audio-video-05.jpg')}}" alt=""></a>
        ...
        <div class="ad--space pd--30-0">
            <a href="#">
                <img src="{{asset('assets/img/ads-img/ad-970x90.jpg')}}" alt="" class="center-block">
            </a>
        </div>
        <!-- Advertisement End -->
                            ...
                            <div class="post--items post--items-3" data-ajax-content="outer">
                                <ul class="nav" data-ajax-content="inner">
                                    <li>
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/health-and-fitness-01.jpg')}}" alt=""></a>
                                                <a href="#" class="cat">Business</a>
                                                <a href="#" class="icon"><i class="fa fa-star-o"></i></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/health-and-fitness-02.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/health-and-fitness-03.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/health-and-fitness-04.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/health-and-fitness-05.jpg')}}" alt=""></a>
                            ...
                            <div class="post--items post--items-2" data-ajax-content="outer">
                                <ul class="nav row gutter--15" data-ajax-content="inner">
                                    <li class="col-xs-12">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/lifestyle-01.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/lifestyle-02.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/lifestyle-03.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/lifestyle-04.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/lifestyle-05.jpg')}}" alt=""></a>
                            ...
                            <div class="post--items" data-ajax-content="outer">
                                <ul class="nav row gutter--15" data-ajax-content="inner">
                                    <li class="col-md-4 col-xs-6 col-xxs-12">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/food-and-resturent-01.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-md-4 col-xs-6 col-xxs-12">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/food-and-resturent-02.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-md-4 hidden-sm hidden-xs">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/food-and-resturent-03.jpg')}}" alt=""></a>
                            ...
                            <div class="post--items post--items-1" data-ajax-content="outer">
                                <ul class="nav row gutter--15" data-ajax-content="inner">
                                    <li class="col-md-12">
                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/photo-gallery-01.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-md-4 col-xs-6 col-xxs-12">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/photo-gallery-02.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-md-4 col-xs-6 col-xxs-12">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/photo-gallery-03.jpg')}}" alt=""></a>
                                    ...
                                    <li class="col-md-4 hidden-sm hidden-xs">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/home-img/photo-gallery-04.jpg')}}" alt=""></a>
                    ...
                    <div class="widget">
                        ...
                        <div class="ad--widget">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a href="#">
                                        <img src="{{asset('assets/img/ads-img/ad-150x150-1.jpg')}}" alt="">
                                    </a>
                                </div>

                                <div class="col-sm-6">
                                    <a href="#">
                                        <img src="{{asset('assets/img/ads-img/ad-150x150-2.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="post--items post--items-3">
                                <ul class="nav" data-ajax-content="inner">
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <span class="thumb"><img src="{{asset('assets/img/widgets-img/readers-opinion-01.png')}}" alt=""></span>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <span class="thumb"><img src="{{asset('assets/img/widgets-img/readers-opinion-02.png')}}" alt=""></span>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <span class="thumb"><img src="{{asset('assets/img/widgets-img/readers-opinion-03.png')}}" alt=""></span>
                            ...
                            <div class="post--items post--items-3">
                                <ul class="nav" data-ajax-content="inner">
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/widgets-img/editors-choice-01.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/widgets-img/editors-choice-02.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/widgets-img/editors-choice-03.jpg')}}" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="{{asset('assets/img/widgets-img/editors-choice-04.jpg')}}" alt=""></a>
