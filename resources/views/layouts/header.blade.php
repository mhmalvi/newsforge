    ...
    <div class="header--mainbar">
        <div class="container">
            ...
            <div class="header--logo float--left float--sm-none text-sm-center">
                <h1 class="h1">
                    <a href="home-1.html" class="btn-link">
                        <img src="{{asset('assets/img/logo.png')}}" alt="USNews Logo">
            ...
            <div class="header--ad float--right float--sm-none hidden-xs">
                <a href="#">
                    <img src="{{asset('assets/img/ads-img/ad-728x90-01.jpg')}}" alt="Advertisement">
                </a>
            </div>
            <!-- Header Ad End -->
        </div>
                                        ...
                                        <div class="megamenu--posts" data-ajax-content="outer">
                                            <ul class="row" data-ajax-content="inner">
                                                <li class="col-md-3">
                                                    <div class="img">
                                                        <a href="news-single-v1.html" class="thumb">
                                                            <img src="{{asset('assets/img/megamenu-img/post-01.jpg')}}" alt="">
                                                        </a>
                                                ...
                                                <li class="col-md-3">
                                                    <div class="img">
                                                        <a href="news-single-v1.html" class="thumb">
                                                            <img src="{{asset('assets/img/megamenu-img/post-02.jpg')}}" alt="">
                                                        </a>
                                                ...
                                                <li class="col-md-3">
                                                    <div class="img">
                                                        <a href="news-single-v1.html" class="thumb">
                                                            <img src="{{asset('assets/img/megamenu-img/post-03.jpg')}}" alt="">
                                                        </a>
                                                ...
                                                <li class="col-md-3">
                                                    <div class="img">
                                                        <a href="news-single-v1.html" class="thumb">
                                                            <img src="{{asset('assets/img/megamenu-img/post-04.jpg')}}" alt="">
                                                        </a>
